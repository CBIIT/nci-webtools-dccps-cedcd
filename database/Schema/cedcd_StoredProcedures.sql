...
begin
select cohort_id, domain_id, domain, baseline, followup from 
major_content m join lu_domain d
on m.domain_id = d.id
where cohort_id = targetID order by domain_id;
end //
...
begin
    ...
    begin
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.seStatusBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.seStatusFollowUp')) where cohort_id = targetID and domain_id = 1;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.educationBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.educationFollowUp')) where cohort_id = targetID and domain_id = 2;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.maritalStatusBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.maritalStatusFollowUp')) where cohort_id = targetID and domain_id = 3;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.originBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.originFollowUp')) where cohort_id = targetID and domain_id = 4;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.empStatusBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.empStatusFollowUp')) where cohort_id = targetID and domain_id = 5;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.insuranceStatusBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.insuranceStatusFollowUp')) where cohort_id = targetID and domain_id = 6;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.anthropometryBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.anthropometryFollowUp')) where cohort_id = targetID and domain_id = 7;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.dietaryBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.dietaryFollowUp')) where cohort_id = targetID and domain_id = 8;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.supplementBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.supplementFollowUp')) where cohort_id = targetID and domain_id = 9;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.medicineBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.medicineFollowUp')) where cohort_id = targetID and domain_id = 10;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.prescriptionBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.prescriptionFollowUp')) where cohort_id = targetID and domain_id = 11;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.nonprescriptionBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.nonprescriptionFollowUp')) where cohort_id = targetID and domain_id = 12;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.alcoholBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.alcoholFollowUp')) where cohort_id = targetID and domain_id = 13;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.cigaretteBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.cigaretteFollowUp')) where cohort_id = targetID and domain_id = 14;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.cigarBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.cigarFollowUp')) where cohort_id = targetID and domain_id = 15;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.pipeBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.pipeFollowUp')) where cohort_id = targetID and domain_id = 16;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.tobaccoBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.tobaccoFollowUp')) where cohort_id = targetID and domain_id = 17;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.ecigarBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.ecigarFollowUp')) where cohort_id = targetID and domain_id = 18;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.noncigarOtherBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.noncigarOtherFollowUp')) where cohort_id = targetID and domain_id = 19;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.noncigarBaseLineSpecify')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.noncigarFollowUpSpecify')) where cohort_id = targetID and domain_id = 20;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.physicalBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.physicalFollowUp')) where cohort_id = targetID and domain_id = 21;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.sleepBaseLine')), followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.sleepFollowUp')) where cohort_id = targetID and domain_id = 22;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.reproduceBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.reproduceFollowUp')) where cohort_id = targetID and domain_id = 23;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.reportedHealthBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.reportedHealthFollowUp')) where cohort_id = targetID and domain_id = 24;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.lifeBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.lifeFollowUp')) where cohort_id = targetID and domain_id = 25;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.socialSupportBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.socialSupportFollowUp')) where cohort_id = targetID and domain_id = 26;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.cognitionBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.cognitionFollowUp')) where cohort_id = targetID and domain_id = 27;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.depressionBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.depressionFollowUp')) where cohort_id = targetID and domain_id = 28;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.psychosocialBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.psychosocialFollowUp')) where cohort_id = targetID and domain_id = 29;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.fatigueBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.fatigueFollowUp')) where cohort_id = targetID and domain_id = 30;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.cancerHistoryBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.cancerHistoryFollowUp')) where cohort_id = targetID and domain_id = 31;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.cancerPedigreeBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.cancerPedigreeFollowUp')) where cohort_id = targetID and domain_id = 32;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.physicalMeasureBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.physicalMeasureFollowUp')) where cohort_id = targetID and domain_id = 33;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.exposureBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.exposureFollowUp')) where cohort_id = targetID and domain_id = 34;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.residenceBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.residenceFollowUp')) where cohort_id = targetID and domain_id = 35;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.diabetesBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.diabetesFollowUp')) where cohort_id = targetID and domain_id = 36;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.strokeBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.strokeFollowUp')) where cohort_id = targetID and domain_id = 37;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.copdBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.copdFollowUp')) where cohort_id = targetID and domain_id = 38;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.cardiovascularBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.cardiovascularFollowUp')) where cohort_id = targetID and domain_id = 39;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.osteoporosisBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.osteoporosisFollowUp')) where cohort_id = targetID and domain_id = 40;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.mentalBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.mentalFollowUp')) where cohort_id = targetID and domain_id = 41;
		update major_content set baseline = JSON_UNQUOTE(JSON_EXTRACT(info, '$.cognitiveDeclineBaseLine')),followup = JSON_UNQUOTE(JSON_EXTRACT(info, '$.cognitiveDeclineFollowUp')) where cohort_id = targetID and domain_id = 42;
		...
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 1, JSON_UNQUOTE(JSON_EXTRACT(info, '$.seStatusBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.seStatusFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 2, JSON_UNQUOTE(JSON_EXTRACT(info, '$.educationBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.educationFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 3, JSON_UNQUOTE(JSON_EXTRACT(info, '$.maritalStatusBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.maritalStatusFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 4, JSON_UNQUOTE(JSON_EXTRACT(info, '$.originBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.originFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 5, JSON_UNQUOTE(JSON_EXTRACT(info, '$.empStatusBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.empStatusFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 6, JSON_UNQUOTE(JSON_EXTRACT(info, '$.insuranceStatusBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.insuranceStatusFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 7, JSON_UNQUOTE(JSON_EXTRACT(info, '$.anthropometryBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.anthropometryFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 8, JSON_UNQUOTE(JSON_EXTRACT(info, '$.dietaryBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.dietaryFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 9, JSON_UNQUOTE(JSON_EXTRACT(info, '$.supplementBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.supplementFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 10, JSON_UNQUOTE(JSON_EXTRACT(info, '$.medicineBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.medicineFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 11, JSON_UNQUOTE(JSON_EXTRACT(info, '$.prescriptionBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.prescriptionFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 12, JSON_UNQUOTE(JSON_EXTRACT(info, '$.nonprescriptionBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.nonprescriptionFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 13, JSON_UNQUOTE(JSON_EXTRACT(info, '$.alcoholBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.alcoholFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 14, JSON_UNQUOTE(JSON_EXTRACT(info, '$.cigaretteBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.originFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 15, JSON_UNQUOTE(JSON_EXTRACT(info, '$.cigarBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.cigarFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 16, JSON_UNQUOTE(JSON_EXTRACT(info, '$.pipeBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.pipeFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 17, JSON_UNQUOTE(JSON_EXTRACT(info, '$.tobaccoBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.tobaccoFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 18, JSON_UNQUOTE(JSON_EXTRACT(info, '$.ecigarBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.ecigarFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 19, JSON_UNQUOTE(JSON_EXTRACT(info, '$.noncigarOtherBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.noncigarOtherFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 20, JSON_UNQUOTE(JSON_EXTRACT(info, '$.noncigarBaseLineSpecify')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.noncigarFollowUpSpecify')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 21, JSON_UNQUOTE(JSON_EXTRACT(info, '$.physicalBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.physicalFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 22, JSON_UNQUOTE(JSON_EXTRACT(info, '$.sleepBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.sleepFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 23, JSON_UNQUOTE(JSON_EXTRACT(info, '$.reproduceBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.reproduceFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 24, JSON_UNQUOTE(JSON_EXTRACT(info, '$.reportedHealthBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.reportedHealthFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 25, JSON_UNQUOTE(JSON_EXTRACT(info, '$.lifeBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.lifeFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 26, JSON_UNQUOTE(JSON_EXTRACT(info, '$.socialSupportBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.socialSupportFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 27, JSON_UNQUOTE(JSON_EXTRACT(info, '$.cognitionBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.cognitionFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 28, JSON_UNQUOTE(JSON_EXTRACT(info, '$.depressionBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.depressionFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 29, JSON_UNQUOTE(JSON_EXTRACT(info, '$.psychosocialBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.psychosocialFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 30, JSON_UNQUOTE(JSON_EXTRACT(info, '$.fatigueBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.fatigueFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 31, JSON_UNQUOTE(JSON_EXTRACT(info, '$.cancerHistoryBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.cancerHistoryFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 32, JSON_UNQUOTE(JSON_EXTRACT(info, '$.cancerPedigreeBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.cancerPedigreeFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 33, JSON_UNQUOTE(JSON_EXTRACT(info, '$.physicalMeasureBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.physicalMeasureFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 34, JSON_UNQUOTE(JSON_EXTRACT(info, '$.exposureBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.exposureFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 35, JSON_UNQUOTE(JSON_EXTRACT(info, '$.residenceBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.residenceFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 36, JSON_UNQUOTE(JSON_EXTRACT(info, '$.diabetesBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.diabetesFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 37, JSON_UNQUOTE(JSON_EXTRACT(info, '$.strokeBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.strokeFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 38, JSON_UNQUOTE(JSON_EXTRACT(info, '$.copdBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.copdFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 39, JSON_UNQUOTE(JSON_EXTRACT(info, '$.cardiovascularBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.cardiovascularFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 40, JSON_UNQUOTE(JSON_EXTRACT(info, '$.osteoporosisBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.osteoporosisFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 41, JSON_UNQUOTE(JSON_EXTRACT(info, '$.mentalBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.mentalFollowUp')), '', '', NOW(), NOW());
		insert into major_content (cohort_id, domain_id, baseline, followup, other_specify_baseline, other_specify_followup, create_time, update_time) values (targetID, 42, JSON_UNQUOTE(JSON_EXTRACT(info, '$.cognitiveDeclineBaseLine')), JSON_UNQUOTE(JSON_EXTRACT(info, '$.cognitiveDeclineFollowUp')), '', '', NOW(), NOW());
        insert into cohort_edit_status (cohort_id, page_code, `status`) 
