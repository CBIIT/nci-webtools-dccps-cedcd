...
const all = {
  ...
  collected_data: {
    ...
    "Genetic Information":
      "bio_genotyping_data,bio_sequencing_data_exome,bio_sequencing_data_whole_genome,bio_epigenetic_or_metabolic_markers",
...
// const config = _.merge(all, require('./template.js'), require('./cedcd.settings'));

const config = merge(all, template, cedcd_settings);
