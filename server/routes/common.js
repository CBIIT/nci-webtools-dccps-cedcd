...
router.post("/export/home", function (req, res) {
  ...
  data.list["Cohort_Selection"].header = [
    ["Cohort Data Export Generated from the CEDCD Website (" + website + ")"],
...
router.post("/export/select", function (req, res) {
  ...
  if (
    filter.participant.gender.length !== 0 ||
    filter.participant.race.length !== 0 ||
    filter.participant.ethnicity.length !== 0 ||
    filter.participant.age.length !== 0
  ) {
...
router.post("/export/advancedSelect", function (req, res) {
  ...
  if (
    ...
    advancedFilter.race.length !== 0 ||
    advancedFilter.ethnicity.length !== 0 ||
...
router.post("/export/enrollment", function (req, res) {
  ...
  data.list["Enrollment_Counts"].header = [
    ["Cohort Data Export Generated from the CEDCD Website (" + website + ")"],
  ...
  mysql.callProcedure(func, params, function (results) {
    if (results && results[0] && results[0].length > 0) {
      ...
      data.list["Enrollment_Counts"].sections = [];
      data.list["Criteria"].header = [["Gender:"], ["Race:"], ["Ethnicity:"], ["Cohorts:"]];
    }
    res.json({ status: 200, data: data });
  });
});
...
router.post("/export/cancer", function (req, res) {
  ...
  data.list["Cancer_Counts"].header = [
    ["Cohort Data Export Generated from the CEDCD Website (" + website + ")"],
  ...
  mysql.callProcedure(func, params, function (results) {
    if (results && results[0] && results[0].length > 0) {
      ...
      list
        .filter((e) => sexList.includes(e.gender_id))
        .forEach(function (l) {
          if (lcache[l.u_id] == null) {
            lcache[l.u_id] = {};
      ...
      data.list["Cancer_Counts"].header.push([]);
      data.list["Cancer_Counts"].header.push([]);
      data.list["Criteria"].header = [["Gender:"], ["Cancer Type:"], ["Cohorts:"]];
    }
    res.json({ status: 200, data: data });
  });
});
...
router.post("/export/biospecimen", function (req, res) {
  ...
  data.list["Biospecimen_Counts"].header = [
    ["Cohort Data Export Generated from the CEDCD Website (" + website + ")"],
  ...
  mysql.callProcedure(func, params, function (results) {
    if (results && results[0] && results[0].length > 0) {
      ...
      data.list["Biospecimen_Counts"].header.push([]);
      data.list["Biospecimen_Counts"].header.push([]);
      data.list["Criteria"].header = [["Specimen Type:"], ["Cancer Type:"], ["Cohorts:"]];
    }
    res.json({ status: 200, data: data });
  });
});
