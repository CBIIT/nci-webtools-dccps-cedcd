...
export default function followupController(req, res) {
  let body = req.body;
  let cohorts = body.cohorts || [];

  let func = "select_cohort_followup_data";
  let params = [];
    ...
    if (results && results[0] && results[0].length > 0) {
      ...
      list.forEach(function (l) {
        ...
        if (v == -1) {
          ...
          v = v ? "Yes" : "No";
          if (l.category_id == 19) {
            if (l.other_specify_followup != "") {
              v = l.other_specify_followup;
            } else if (v == "No") {
              v = "N/A";
            } else {
              v = "N/P";
      ...
      values.forEach(function (vl) {
        ...
        let followups = dict[vl.category_id];
