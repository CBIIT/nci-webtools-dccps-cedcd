...
export function EnrollmentFunctions(gender, race, ethnicity) {
  ...
  if (ethnicity_len !== 0 || race_len !== 0 || gender_len !== 0) {
    if (
      (ethnicity_len === Object.keys(config.ethnicity).length || ethnicity_len === 0) &&
      (race_len === Object.keys(config.race).length || race_len === 0) &&
      (gender_len === Object.keys(config.gender).length || gender_len === 0)
    ) {
