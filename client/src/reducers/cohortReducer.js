...
actions[t.setCollectedOther] = (state, action) => ({...state, data_collected_other: action.value, data_collected_other_specify: state.data_collected_other === 1 ? state.data_collected_other_specify : ''})
