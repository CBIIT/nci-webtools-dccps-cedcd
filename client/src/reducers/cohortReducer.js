...
actions[t.setCollectedInPerson] = (state, action) => ({...state, collectedInPerson: action.inPerson})
actions[t.setCollectedPhone] = (state, action) => ({...state, collectedPhone: action.byPhone})
actions[t.setCollectedPaper] = (state, action) => ({...state, collectedPaper: action.byPaper})
actions[t.setCollectedWeb] = (state, action) => ({...state, collectedWeb: action.onWeb})
actions[t.setCollectedOther] = (state, action) => ({...state, collectedOther: action.other, collectedOtherSpecify: action.other === '1' ? state.collectedOtherSpecify : ''})
