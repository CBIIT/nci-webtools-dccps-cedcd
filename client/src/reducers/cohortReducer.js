...
actions[t.setSpecimenUrl] = (state, action) => ({...state, specimenUrl: action.url === 'null' ? '' : action.url})
actions[t.setPublicationUrl] = (state, action) => ({...state, publicationUrl: action.url === 'null' ? '' : action.url})
