...
actions[t.investigatorName] = (state, action) => {let cloned = {...state}; if(action.remove){if(cloned['investigator_name_'+action.index]) delete clonedcloned['investigator_name_'+action.index]}else{if(!clonedcloned['investigator_name_'+action.index]) cloned['investigator_name_'+action.index] = action.value}; return cloned}
actions[t.investigatorInsitution] = (state, action) => {let cloned = {...state}; if(action.remove){if(cloned['investigator_inst_'+action.index]) delete clonedcloned['investigator_inst_'+action.index]}else{if(!clonedcloned['investigator_inst_'+action.index]) clonedcloned['investigator_inst_'+action.index] = action.value}; return cloned}
...
const cohortErrorReducer = (state=InitialStates.cohort, action={}) => getResult(state)(action)
