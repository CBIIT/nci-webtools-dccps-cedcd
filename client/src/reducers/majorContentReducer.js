...
actions[t.setPhychosocialBaseLine] = (state, action) => ({...state, phychosocialBaseLine: action.value})
actions[t.setPhychosocialFollowUp] = (state, action) => ({...state, phychosocialFollowUp : action.value})
