const InitialStates = {
    ...
    cohortErrors: {
        completionDate: 'missing required field value',
        clarification_contact: 'please choose one',
        completerName: 'missing required field value',
        completerPosition: 'missing required field value',
        completerEmail: 'missing required field value',
        contacterName: 'missing required field value',
        contacterPosition: 'missing required field value',
        contacterEmail: 'missing required field value',
        collaboratorName: 'missing required field value',
        collaboratorPosition: 'missing required field value',
        collaboratorEmail: 'missing required field value',
        eligible_gender_id: 'please select one',
        enrollment_ongoing: 'please select one',
        enrollment_total: 'missing required field value',
        enrollment_year_start: 'missing required field value',
        enrollment_year_end: 'missing required field value',
        enrollment_ongoing: 'please select one',
        enrollment_target: 'missing required field value',
        enrollment_year_complete: 'missing required field value',
        enrollment_age_min: 'missing required field value',
        enrollment_age_max: 'missing required field value',
        enrollment_age_mean: 'missing required field value',
        enrollment_age_median: 'missing required field value',
        current_age_min: 'missing required field value',
        current_age_max: 'missing required field value',
        current_age_mean: 'missing required field value',
        current_age_median: 'missing required field value',
        time_interval: 'missing required field value',
        most_recent_year: 'missing required field value',
        ...
        data_collected_other_specify: 'missing required field value',
        restrictions_other_specify: 'missing required field value',
        strategy_other_specify: 'missing required field value',
        questionnaire: true,
        main: true,
        data: true,
        specimen: true,
    ...
    enrollmentCountErrors: {
        mostRecentDate: 'missing required field value'
    },
    majorContent: {
        hasLoaded: false,
