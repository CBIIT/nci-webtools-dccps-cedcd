...
const bioBloodBaselineOtherDerivative = (disabled) => ({ type: t.bioBloodBaselineOtherDerivative, toDisable: disabled })
...
const bioBloodOtherTimeOtherDerivative = (disabled) => ({ type: t.bioBloodOtherTimeOtherDerivative, toDisable: disabled })
...
const bioRepeatedSampleSameIndividual = (disabled) => ({ type: t.bioRepeatedSampleSameIndividual, toDisable: disabled })
...
const bioEpigeneticOrMetabolicMarkers = (disabled) => ({ type: t.bioEpigeneticOrMetabolicMarkers, toDisable: disabled })
...
const bioMetaOutcomesOtherStudySpecify = (disabled) => ({ type: t.bioMetaOutcomesOtherStudySpecify, toDisable: disabled })
