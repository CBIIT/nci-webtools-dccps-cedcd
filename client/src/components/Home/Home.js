  ...
  render() {
    ...
    return (
      <div className="conatiner p-0 m-0 mw-100">
        <img
          src="./assets/img/HomeHeader.jpeg"
          alt="Header"
          style={{ width: "100%", padding: "0 1.5rem", marginBottom: "2rem" }}></img>
        <p className="welcome">
          ...
          size), the type of data collected at baseline, cancer sites, number of participants diagnosed with cancer, and
          biospecimen information. All data included in this database are aggregated for each cohort; there are no
            ...
            <Link
              ...
              <div className="animation-card" style={{ backgroundColor: "#2868af" }} align="center">
                <div className="card-top-coloring" style={{ backgroundColor: "#5da9d3" }}>
                  ...
                  <img
                    src="./assets/img/Search_Cohorts_Icon.png"
                    alt="Header"
            ...
            <Link
              ...
              <div className="animation-card" style={{ backgroundColor: "#c1270e" }} align="center">
                <div className="card-top-coloring" style={{ backgroundColor: "#cf5848" }}>
                  <img
                    src="./assets/img/Enrollment_Counts_Icon.png"
                    alt="Header"
