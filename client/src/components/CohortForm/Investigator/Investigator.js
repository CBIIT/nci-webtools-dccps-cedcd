  ...
  return (
    <Form id={id}>
      <Col sm="12" className="py-3 px-0" style={{ border: "1px solid lightgray" }}>
              ...
              {errors[name] && displayStyle ? (
                <Reminder message={errors[name]}>
                  <Form.Control
                    ...
                    onBlur={(e) => populateErrors(idx, "investigatorName", e.target.value, true, "string")}
                  />
                </Reminder>
              ) : (
                <Form.Control
              ...
              {errors[institution] && displayStyle ? (
                <Reminder message={errors[institution]}>
                  <Form.Control
                    ...
                    onBlur={(e) => populateErrors(idx, "investigatorInstitution", e.target.value, true, "string")}
                  />
                </Reminder>
              ) : (
                <Form.Control
              ...
              {errors[email] && displayStyle ? (
                <Reminder message={errors[email]}>
                  <Form.Control
                    ...
                    onBlur={(e) => populateErrors(idx, "investigatorEmail", e.target.value, true, "email")}
                  />
                </Reminder>
              ) : (
                <Form.Control
        ...
        <Col sm="6">
          {idx !== "0" && !disabled && (
            <div className="inspectorClose float-right" style={{ color: "blue" }} onClick={() => handleRemove(idx)}>
              Remove
            </div>
          )}
        </Col>
