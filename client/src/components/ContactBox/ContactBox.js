  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className={shadow} onClick={this.handleClick}>
        </div>
              ...
              <div id="contact-col-1" className="col-md-6 contact-col">
                <form onSubmit={this.handleSubmit}>  
                  ...
                  <div id="ctl11_div_firstname" className={firstname_cls}>
                    ...
                    <input className="w-100" name="cu_firstName" type="text" id="cu_firstName" value={this.state.firstname} onChange={(e) =>this.handleChange("firstname",e)}/>
                  </div>
                  <div id="ctl11_div_lastname" className={lastname_cls}>
                    ...
                    <input className="w-100" name="cu_lastName" type="text" id="cu_lastName" value={this.state.lastname} onChange={(e) =>this.handleChange("lastname",e)}/>
                  </div>
                  <div id="ctl11_div_organization" className={org_cls}>
                    ...
                    <input className="w-100" name="cu_organization" type="text" id="cu_organization" value={this.state.organization} onChange={(e) =>this.handleChange("organization",e)}/> 
                  </div>
                  <div id="ctl11_div_phone" className={phone_cls}>
                    <label className="oneLineLabel" htmlFor="cu_phone">Phone Number</label>
                    <input className="w-100" name="cu_phone" type="text" id="cu_phone" placeholder="" value={this.state.phone} onChange={(e) =>this.handleChange("phone",e)}/>
                  </div>
                  ...
                  <input className="w-100" name="cu_email" type="text" id="cu_email" value={this.state.email} onChange={(e) =>this.handleChange("email",e)}/>
                  </div>
                  ...
                  <select name="cu_topic" id="cu_topic" className="textEntrySmall w-100" value={this.state.topic}  onChange={(e) =>this.handleChange("topic",e)}>
                  ...
                  <textarea className="w-100" name="cu_message" rows="4" cols="20" id="cu_message" value={this.state.message} onChange={(e) =>this.handleChange("message",e)}/>
                  </div>
