...
class Baseline extends Component {
  ...
  loadingData = (next) => {
    ...
    const filename = "compare_Baseline Data_" + ds + ".xlsx";
    const data = {};
    data.filename = filename;
    data.list = {};
    data.list["Baseline_Data"] = {};
    data.list["Baseline_Data"].header = [
      ["Cohort Data Export Generated from the CEDCD Website (cedcd.nci.nih.gov)"],
      ["Table Name:", "Cohort Overview Tab: Data Collected at Baseline"],
      ["Export Date:", dt],
      [],
      [],
    ];
    ...
    data.list["Baseline_Data"].rows = rows;
    next(data);
  };
  ...
  render() {
    ...
    params.config.sideHeader = [
      48, 40, 40, 40, 40, 40, 40, 40, 40, 48, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 48, 40, 40, 40, 40, 40,
      40, 40, 40, 40, 40, 40, 40, 40, 40, 48, 40, 40, 40, 40, 40, 40, 40,
    ];
    ...
    let exportTable = (
      <Workbook
        ...
        <Workbook.Sheet name="Baseline_Data">
    ...
    return (
      <div id="cedcd-cohorts-inner" className="col-md-12 activeArea">
        <div className="table-inner col-md-12">
          <div className="table-legend col-sm-9">
            {" "}
            <span className="">N/A: Not Applicable; N/P: Not Provided</span>{" "}
          </div>
          <div className="table-export col-sm-3">{exportTable}</div>
