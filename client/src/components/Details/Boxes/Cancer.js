...
class Cancer extends Component {
	...
	loadingData = (next) =>{
		...
		data.list["Cancer_Info"].header = [["Cohort Data Export Generated from the CEDCD Website (cedcd.nci.nih.gov)"],
  ...
  render() {
    ...
    let params = {};
  	...
  	params.config.sideHeader = [48,40,40,40,40,40,40,48,40,40,40,40,40,40,40,40,40,40,40,40,40,48,40,40,40,40,40,40,48,40,40,40,40];
