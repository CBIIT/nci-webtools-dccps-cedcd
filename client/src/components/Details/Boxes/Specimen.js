...
class Specimen extends Component {
	...
	loadingData = (next) =>{
		...
		data.list["Specimen Overview"].header = [["Cohort Data Export Generated from the CEDCD Website (cedcd.nci.nih.gov)"],
  ...
  render() {
    ...
    let params = {};
  	...
  	params.config.sideHeader = [48,40,40,40,40,40,40,40,40,40,40,48,40,40,48,40,40,40,48,40,40,40,40,40];
