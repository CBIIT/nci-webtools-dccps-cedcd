    ...
    return <div id='cancerInfoContainer' className='col-md-12'>
        <div className='col-md-12' style={{display: 'flex', flexDirection: 'column'}}>           
            <div style={{marginTop: '20px', marginBottom: '20px'}}>
                <span><b>D.1 Cancer Counts</b></span><span>{' '}Please enter the number of participants with these cancer by sex</span>
            </div>
            <div>
                <table className='table table-stripe table-responsive'>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input className='inputWriter'  style={{textAlign: 'center'}} name='16-2-1' value={cancerInfo['16-2-1']} onChange={e=>dispatch(allactions.cancerInfoActions.setCancerCount('16-2-1', e.target.value))} /></td>
                            <td><input className='inputWriter'  style={{textAlign: 'center'}} name='16-2-2' value={cancerInfo['16-2-2']} onChange={e=>dispatch(allactions.cancerInfoActions.setCancerCount('16-2-2', e.target.value))} /></td>
                            <td><input className='inputWriter'  style={{textAlign: 'center'}} name='16-1-1' value={cancerInfo['16-1-1']} onChange={e=>dispatch(allactions.cancerInfoActions.setCancerCount('16-1-1', e.target.value))} /></td>
                            <td><input className='inputWriter'  style={{textAlign: 'center'}} name='16-1-2' value={cancerInfo['16-1-2']} onChange={e=>dispatch(allactions.cancerInfoActions.setCancerCount('16-1-2', e.target.value))} /></td>
                        </tr>
                        <tr>
                            <td style={{textAlign: 'center'}}>233</td>
