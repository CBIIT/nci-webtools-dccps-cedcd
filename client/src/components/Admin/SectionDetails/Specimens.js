...
const SpecimenForm = ({ ...props }) => {
    ...
    return (
        <div id='specimenInfoContainer' className='col-md-12'>
            ...
            <div className='col-md-12' style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                {/* START Specimens Collapsable Question Sections */}
                <div className="row">
                    <div id="attachments" className="cohortInfo col-md-12">
                        {/* START Specimen Collected */}
                        <button type="button" 
                        ...
                        {/* END Specimen Collected */}
                        {/* START Biospecimen Counts */}
                        <button type="button" 
                ...
                {/* END Specimens Collapsable Question Sections */}
