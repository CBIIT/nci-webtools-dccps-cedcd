        ...
        <div className='col-md-12' style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <div>
                <form id='currentForm' readOnly>
                    {/* START Basic Information Collapsible Question Sections */}
                    <div className="row">
                        <div id="attachments" className="cohortInfo col-md-12">
                            ...
                            <button type="button" 
                                ...
                                onClick={() => setActivePanel(activePanel === 'panelA' ? '' : 'panelA')}>
                                    <span className="triangle"></span>Cohort Information
                            </button>
                            ...
                            {/* END Cohort Information */}
                            {/* START Principal Investigators */}
                            <button type="button" 
                                ...
                                onClick={() => setActivePanel(activePanel === 'panelB' ? '' : 'panelB')}>
                                    <span className="triangle"></span>Principal Investigators
                            </button>
                            <div className="cohortInfoBody" 
                                id="more" 
                            ...
                            {/* END Principal Investigators */}
                            {/* START Eligibility & Enrollment */}
                            <button type="button" 
                                ...
                                onClick={() => setActivePanel(activePanel === 'panelC' ? '' : 'panelC')}>
                                    <span className="triangle"></span>Eligibility & Enrollment
                            </button>
                            <div className="cohortInfoBody" 
                                id="more" 
                            ...
                            {/* END Eligibility & Enrollment */}
                            {/* START Requirements & Strategies */}
                            <button type="button" 
                                ...
                                onClick={() => setActivePanel(activePanel === 'panelD' ? '' : 'panelD')}>
                                    <span className="triangle"></span>Requirements & Strategies
                            </button>
                            <div className="cohortInfoBody" 
                                id="more" 
                            ...
                            {/* END Requirements & Strategies */}
                            {/* START Documents */}
                            <button type="button" 
                                className={'cedcd-btn ' + (activePanel === 'panelE' ? 'active' : '')} 
                                aria-expanded={activePanel === 'panelE'} 
                                aria-controls="more" 
                                onClick={() => setActivePanel(activePanel === 'panelE' ? '' : 'panelE')}>
                                    <span className="triangle"></span>Documents
                            </button>
                            <div className="cohortInfoBody" 
                                id="more" 
                                aria-hidden={activePanel === 'panelE' ? 'false' : 'true'} 
                                style={{
                                    display: activePanel === 'panelE' ? 'block' : 'none'
                                }}>                            
                                    ...
                                    <div id='question15' className='col-md-12' style={{ paddingTop: '10px', paddingBottom: '10px' }}>
                                        ...
                                        <div className='col-md-12'>
                                            <div className="table-responsive">
                                                <table className='table table-striped' readOnly>
                                                    <thead>
                                                        <tr>
                    ...
                    {/* END Basic Information Collapsible Question Sections */}
                </form>
