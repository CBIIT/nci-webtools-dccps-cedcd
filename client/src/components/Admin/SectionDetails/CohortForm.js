                    ...
                    <div className={activePanel === 'panelA' ? 'panel-active' : 'panellet'}>
                        ...
                        <div id='question6' className='col-md-12' style={{ paddingTop: '10px', paddingBottom: '10px' }}>
                            ...
                            <div className='col-md-8' style={{ maxWidth: '670px' }}>
                                <span className='col-md-12' style={{ margin: '0', padding: '0' }}><input className='form-control' name='websiteurl' value={cohort.webSite} /></span>
                            </div>
                        </div>
                        <div className='form-group col-md-12'>
                            <div className='col-md-12'>
                            ...
                            <div>
                                <div className='col-md-12' style={{ marginBottom: '15px' }}>
                                    ...
                                    <span className='col-md-2' style={{ marginRight: '0' }}>
                                        <input type='radio' name='eligibleGender' value='4' checked={cohort.eligibleGender === 4} />{' '} Both genders
                                    </span>
                                    <span className='col-md-2' style={{ marginRight: '0' }}>
                                        <input type='radio' name='eligibleGender' value='2' checked={cohort.eligibleGender === 2} />{' '} Males only
                                    </span>
                                    <span className='col-md-2' style={{ marginRight: '0' }}>
                                        <input type='radio' name='eligibleGender' value='1' checked={cohort.eligibleGender === 1} />{' '} Females only
                                    </span>
                                ...
                                <div className='col-md-12' style={{ marginBottom: '10px' }}>
                                    ...
                                    <div className='col-md-12'>
                                        <input type='checkbox' name='cancerSurvivors' checked={cohort.hasCancerSite} />{' '} Cancer survivors only, specify cancer site(s)
                                    </div>
                                    <div className='col-md-6' style={{ marginBottom: '20px' }}>
                                        <input name='cancerSites' className='form-control' value={cohort.cancerSites} maxlength='100' placeholder='no more than 100 characters' disabled={!cohort.hasCancerSite} />
                                    </div>
                                    <div className='col-md-12' style={{ paddingLeft: '0', paddingRight: '0' }}>
                                        ...
                                        <div className='col-md-6' style={{ paddingLeft: '0', paddingRight: '0' }}>
                                            <span className='col-md-12'>
                                                <input className='form-control' placeholder='no more than 100 characters' maxLength='100' name='otherCriteria' value={cohort.eligibilityCriteriaOther} />
                                            </span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id='question9' className='col-md-12' style={{ paddingTop: '10px', paddingBottom: '10px' }}>
                            ...
                            <div className='col-md-12' style={{ paddingLeft: '0' }}>
                                ...
                                <span className='col-md-2'>
                                    <input className='form-control' name='enrollTotal' value={cohort.enrolledTotal} />
                                </span>

                            </div>
                            <div className='col-md-12' style={{ paddingLeft: '0' }}>
                                <span className='col-md-6' style={{ lineHeight: '2em' }}> Started in year<span style={{ color: 'red' }}>*</span></span>
                                <span className='col-md-2'><input className='form-control' name='enrollStartYear' placeholder='yyyy' value={cohort.enrollStartYear} /></span>
                            ...
                            <div className='col-md-12' style={{ paddingLeft: '0', marginBottom: '8px' }}>
                                ...
                                <span className='col-md-2'><input className='form-control' name='enrollEndYear' placeholder='yyyy' value={cohort.enrollEndYear} /></span>
                            ...
                            <div className='col-md-12' style={{ marginBottom: '8px' }}>
                                ...
                                <span className='col-md-1'><input type='radio' name='enrollmentCurrent' value='0' checked={cohort.enrollOnGoing === 0} /> No</span>
                                <span className='col-md-1'><input type='radio' name='enrollmentCurrent' value='1' checked={cohort.enrollOnGoing === 1} /> Yes</span>
                            </div>
                            <div className='col-md-12' style={{ paddingLeft: '0' }}>
                                <span className='col-md-6' style={{ lineHeight: '2em' }}>
                                ...
                                <span className='col-md-2'>
                                    <input className='form-control' name='targetNumber' value={cohort.numOfPlans} />
                                </span>
                            </div>
                            <div className='col-md-12' style={{ paddingLeft: '0' }}>
                                <span className='col-md-6' style={{ lineHeight: '2em' }}>
                                ...
                                <span className='col-md-2'>
                                    <input className='form-control' name='yearToComplete' placeholder='yyyy' value={cohort.yearToComplete} />
                                </span>
                            </div>
                            ...
                            <div className='col-md-12' style={{ paddingLeft: '0' }}>
                                <div>
                                    ...
                                    <span className='col-md-2'>
                                        <input className='form-control' name='baseLineMinAge' value={cohort.baseLineMinAge} />
                                    </span>
                                    <span className='col-md-1' style={{ lineHeight: '2em', padding: '0', margin: '0', width: '15px' }}> to </span>
                                    <span className='col-md-2'><input className='form-control' name='baseLineMaxAge' value={cohort.baseLineMaxAge} /></span>
                                </div>

                                <div>
                                    <span className='col-md-6' style={{ lineHeight: '2em' }}>Median age<span style={{ color: 'red' }}>*</span></span>
                                    <span className='col-md-2'><input className='form-control' name='baseLineMedian' value={cohort.baseLineMedianAge} /></span>
                                </div>
                                <div>
                                    <span className='col-md-6' style={{ lineHeight: '2em' }}> Mean age<span style={{ color: 'red' }}>*</span> </span>
                                    <span className='col-md-2'><input className='form-control' name='baseLineMean' value={cohort.baseLineMeanAge} /></span>
                                </div>
                            </div>
                            <div className='col-md-12' style={{ paddingLeft: '0' }}>
                                <div>
                                    <span className='col-md-6' style={{ lineHeight: '2em' }}>Current age range of enrolled subjects<span style={{ color: 'red' }}>*</span></span>
                                    <span className='col-md-2'><input className='form-control' name='currentMinAge' value={cohort.currentMinAge} /></span>
                                    <span className='col-md-1' style={{ lineHeight: '2em', padding: '0', margin: '0', width: '15px' }}> to </span>
                                    <span className='col-md-2'><input className='form-control' name='currentMaxAge' value={cohort.currentMaxAge} /></span>
                                </div>
                                <div className='col-md-12'>
                                </div>
                                <div>
                                    <span className='col-md-6' style={{ lineHeight: '2em' }}>Median age<span style={{ color: 'red' }}>*</span></span>
                                    <span className='col-md-2'><input className='form-control' name='currentMedian' value={cohort.currentMedianAge} /></span>
                                </div>
                                <div>
                                    <span className='col-md-6' style={{ lineHeight: '2em' }}> Mean age<span style={{ color: 'red' }}>*</span> </span>
                                    <span className='col-md-2'><input className='form-control' name='currentMean' value={cohort.currentMeanAge} /></span>
                    ...
                    <div className={activePanel === 'panelD' ? 'panel-active' : 'panellet'}>
                        <div id='question10' className='col-md-12' style={{ paddingTop: '10px', paddingBottom: '10px' }}>
                            ...
                            <div className='col-md-8' style={{ padding: '0 3px' }}>
                                <span className='col-md-12' style={{ paddingLeft: '8px', paddingRight: '18px', marginLeft: '0' }}><input className='form-control' name='frequency' value={cohort.timeInterval} /></span>
                        ...
                        <div id='question11' className='col-md-12' style={{ paddingTop: '10px' }}>
                            <div className='col-md-12'>
                                ...
                                <span className='col-md-2'><input className='form-control' name='mostRecentYear' value={cohort.mostRecentYear} /></span>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column' }}>
                                <div>
                                    <span className='col-md-1' style={{ paddingRight: '0', marginRight: '0', width: '50px' }}>
                                        <input type='checkbox' name='collectedInPerson' checked={cohort.collectedInPerson == 1} />{' '}
                                    </span>
                                    <span>In person</span>
                                </div>
                                <div>
                                    <span className='col-md-1' style={{ paddingRight: '0', marginRight: '0', width: '50px' }}>
                                        <input type='checkbox' name='collectedPhone' checked={cohort.collectedPhone == 1} />{' '}
                                    </span>
                                    <span>Phone interview</span>
                                </div>
                                <div>
                                    <span className='col-md-1' style={{ paddingRight: '0', marginRight: '0', width: '50px' }}>
                                        <input type='checkbox' name='collectedPaper' checked={cohort.collectedPaper == 1} />{' '}
                                    </span>
                                    <span>Self-administered via paper</span>
                                </div>
                                <div>
                                    <span className='col-md-1' style={{ paddingRight: '0', marginRight: '0', width: '50px' }}>
                                        <input type='checkbox' name='collectedWeb' checked={cohort.collectedWeb == 1} />{' '}
                                    </span>
                                    <span>Self-administered via web-based device</span>
                                </div>
                                <div>
                                    <span className='col-md-1' style={{ paddingRight: '0', marginRight: '0', width: '50px' }}>
                                        <input type='checkbox' name='collectedOther' checked={cohort.collectedOther == 1} />{' '}
                                    </span>
                                    <span className='col-md-1' style={{ paddingLeft: '0', marginLeft: '0', marginRight: '0', width: '50px' }}>Other</span>
                                    {
                                        cohort.collectedOther ?
                                            <span className='col-md-6' style={{ marginLeft: '0' }}>
                                                <input style={{ height: '20px' }} name='collectedOtherSpecify' className='form-control' value={cohort.collectedOtherSpecify} placeholder='no more than 100 characters' />
                                            </span> : ''
                                    }
                            ...
                            <div>
                                ...
                                <span className='col-md-1' style={{ lineHeight: '1.4em', padding: '0', margin: '0', width: '50px' }}>Other</span>
                                {
                                    cohort.restrictOther === 1 ?
                                        <span className='col-md-6' style={{ margin: '0' }}><input style={{ height: '20px' }} className='form-control' name='restrictOtherSpecify' placeholder='no more than 100 characters' value={cohort.restrictOtherSpecify} /></span> : ''
                                }
                            </div>
                        </div>
                        ...
                        <div id='question14' className='col-md-12' style={{ paddingTop: '10px', paddingBottom: '10px' }}>
                            ...
                            <div>
                                <span className='col-md-1' style={{ paddingRight: '0', marginRight: '0', width: '50px' }}><input type='checkbox' name='strategyRoutine' checked={cohort.strategyRoutine === 1} /></span>
                                <span style={{ lineHeight: '1.4em' }}>Nothing beyond mailing questionnaires or other routine contacts </span>
                            </div>
                            <div>
                                <span className='col-md-1' style={{ paddingRight: '0', marginRight: '0', width: '50px' }}><input type='checkbox' name='strategyMailing' checked={cohort.strategyMailing === 1} /></span>
                                <span style={{ lineHeight: '1.4em' }}>Send newsletters or other general mailings (e.g., birthday cards)</span>
                            </div>
                            <div>
                                <span className='col-md-1' style={{ paddingRight: '0', marginRight: '0', width: '50px' }}><input type='checkbox' name='strategyAggregateStudy' checked={cohort.strategyAggregateStudy === 1} /></span>
                                <span style={{ lineHeight: '1.4em' }}>Return aggregate study results (e.g., recent findings)  </span>
                            </div>
                            <div>
                                <span className='col-md-1' style={{ paddingRight: '0', marginRight: '0', width: '50px' }}><input type='checkbox' name='strategyIndividualStudy' checked={cohort.strategyIndividualStudy === 1} /></span>
                                <span style={{ lineHeight: '1.4em' }}>Individual study results (e.g., nutrient values)</span>
                            </div>
                            <div>
                                <span className='col-md-1' style={{ paddingRight: '0', marginRight: '0', width: '50px' }}><input type='checkbox' name='strategyInvitation' checked={cohort.strategyInvitation === 1} /></span>
                                <span style={{ lineHeight: '1.4em' }}>Invite participation on research committees</span>
                            </div>
                            <div>
                                <span className='col-md-1' style={{ paddingRight: '0', marginRight: '0', width: '50px' }}><input type='checkbox' name='strategyOther' checked={cohort.strategyOther === 1} /></span>
                                <span className='col-md-1' style={{ lineHeight: '1.4em', padding: '0', margin: '0', width: '50px' }}>Other</span>
                                {
                                    cohort.strategyOther ?
                                        <span className='col-md-6' style={{ margin: '0' }}><input style={{ height: '20px' }} className='form-control' name='strategyOtherSpecify' value={cohort.strategyOtherSpecify} placeholder='no more than 100 characters' /></span> : ''
                                }
                            </div>
                        </div>
                    </div>
                                ...
                                <table className='table table-stripe table-responsive table-borderless' readOnly>
                                    ...
                                    <tbody>
                                        <tr className={''}>
                                            ...
                                            <td><input className='inputWriter' name='questionnaireUrl' id='questionnaireUrl' disabled={cohort.questionnaireFileName} value={cohort.questionnaireUrl} readOnly /></td>
                                            <td >
                                        ...
                                        <tr className={''}>
                                            ...
                                            <td><input className='inputWriter' name='mainCohortUrl' id='mainCohortUrl' disabled={cohort.mainFileName} value={cohort.mainCohortUrl} readOnly /></td>
                                        ...
                                        <tr className={''}>
                                            ...
                                            <td><input className='inputWriter' name='dataUrl' id='dataUrl' disabled={cohort.dataFileName} value={cohort.dataUrl} readOnly /></td>
                                        ...
                                        <tr className={''}>
                                            ...
                                            <td><input className='inputWriter' name='specimenUrl' id='specimenUrl' disabled={cohort.specimenFileName} value={cohort.specimenUrl} readOnly /></td>
                                        ...
                                        <tr className={''}>
                                            ...
                                            <td><input className='inputWriter' name='publicationUrl' value={cohort.publicationUrl} id='publicationUrl' disabled={cohort.publicationFileName} readOnly /></td>
