            ...
            <div>
                        ...
                        <div id="attachments" className="cohortInfo col-md-12">
                            ...
                            <button type="button" 
                                ...
                                onClick={() => setActivePanel(activePanel === 'panelA' ? '' : 'panelA')}>
                                    <span className="triangle"></span>Question C1 through C14
                            </button>
                            ...
                            {/* END Question C1 through C14 */}
                            {/* START Question C15 through C29 */}
                            <button type="button" 
                                ...
                                onClick={() => setActivePanel(activePanel === 'panelB' ? '' : 'panelB')}>
                                    <span className="triangle"></span>Question C15 through C29
                            </button>
                            <div className="cohortInfoBody" 
                                id="more" 
                            ...
                            {/* END Question C15 through C29 */}
                            {/* START Question C30 & C31 */}
                            <button type="button" 
                                ...
                                onClick={() => setActivePanel(activePanel === 'panelC' ? '' : 'panelC')}>
                                    <span className="triangle"></span>Question C30 & C31
                            </button>
                            <div className="cohortInfoBody" 
                                id="more" 
                ...
                <div style={{ position: 'relative' }}>
                    <span className='col-md-6 col-xs-12' style={{ position: 'relative', float: 'left', paddingLeft: '0', paddingRight: '0' }}>
                        <input type='button' className='col-md-3 col-xs-6 btn btn-primary' style={{float: 'left'}} value='Previous' onClick={() => props.sectionPicker('B')} />
                        <input type='button' className='col-md-3 col-xs-6 btn btn-primary' style={{float: 'left'}} value='Next' onClick={() => props.sectionPicker('D')} />
                    </span>
