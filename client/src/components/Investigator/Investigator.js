...
const Investigator = ({id, name, institution, email, isRequired, callback, errors, displayStyle}) => {
    ...
    return <div id={id} className='col-md-12' style={{paddingLeft: '0', marginBottom: '10px'}}>
                <div className='col-md-12' style={{marginBottom: '4px'}}>
                    <span className='col-md-2' style={{lineHeight: '2em', paddingLeft: '0'}}>Name{idx === '0' ? <span style={{color: 'red'}}>*</span> :''}</span>
                ...
                <div  className='col-md-12' style={{marginBottom: '4px'}}>
                    <span className='col-md-2'  style={{lineHeight: '2em', paddingLeft: '0'}}>Institution{idx === '0' ? <span style={{color: 'red'}}>*</span> :''}</span>
                    <span className='col-md-6'>
                ...
                <div  className='col-md-12' style={{marginBottom: '4px'}}>
                    <span className='col-md-2'  style={{lineHeight: '2em', paddingLeft: '0'}}>Email{idx === '0' ? <span style={{color: 'red'}}>*</span> :''}</span>
                    <span className='col-md-6'>
