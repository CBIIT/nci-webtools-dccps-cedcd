...
export default function RoutedApp() {
	const [modal, setModal] = useState({
		...
		body: <div className="py-4">Make sure all the changes were saved before leaving the page. Please confirm that you wish to navigate away from the current page.</div>,
		footer: <div>
