	            ...
	            steps={[
	              {
	                ...
	                body: <div style={tourMessageStyle}>This table lists all the <b>participating cohorts,</b> which can be <b>sorted by cohort name or acronym.</b></div>
	              },
	              {
	                step: 2,
	                selector: "#inKeyword",
	                title: <div style={tourTitleStyle}>2 of 3</div>,
	                body: <div style={tourMessageStyle}>You can also <b>search</b> for a specific cohort <b>by name or acronym.</b></div>,
	                position:"bottom"
	              },
	              {
	                step: 3,
	                ...
	                body: <div style={tourMessageStyle}><b>Table data</b> can be <b>exported</b> in an <b>Excel</b> format.  This is available on every table.</div>
	              }
	            ]}
	          />
		);
