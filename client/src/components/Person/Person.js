...
const Person =({id, type, name, position, phone, email, colWidth, errors, disabled, displayStyle, leftPadding}) => {
    ...
    return window.innerWidth <= 1000 ?  <div id={id} className='col-md-12'>
            <div className='col-xs-12' style={{paddingLeft: '0', marginBottom: '5px'}}>
                ...
                <input style={{border: '1px solid red'}} className='form-control' name={name} value={cohort[name]} onChange={e => dispatch(allactions.cohortActions[name](e.target.value))} onBlur={(e) => {populateErrors(name, e.target.value, true, 'string')}}/></div></Reminder> : <div className='col-md-12' style={{padding: '0'}}>
                <input className='form-control' name={name} value={cohort[name]} onChange={e => dispatch(allactions.cohortActions[name](e.target.value))} onBlur={(e) => {populateErrors(name, e.target.value, true, 'string')}} disabled={disabled}/></div>}  
            </div>
            <div className='col-xs-12' style={{paddingLeft: '0', marginBottom: '5px'}}>
                ...
                <input style={{border: '1px solid red'}} className='form-control' name={position} value={cohort[position]} onChange={e => dispatch(allactions.cohortActions[position](e.target.value))} onBlur={(e) => {populateErrors(position, e.target.value, true, 'string')}}/></div></Reminder> : <div className='col-md-12' style={{padding: '0'}}>
                <input className='form-control' name={position} value={cohort[position]} onChange={e => dispatch(allactions.cohortActions[position](e.target.value))} onBlur={(e) => {populateErrors(position, e.target.value, true, 'string')}} disabled={disabled}/></div>}  
            </div>
            <div className='col-xs-12' style={{paddingLeft: '0', marginBottom: '5px'}}>
            ...
            <div className='col-xs-12' style={{paddingLeft: '0', marginBottom: '5px'}}>
                ...
                <input style={{border: '1px solid red'}} className='form-control' name={email} value={cohort[email]} onChange={e => dispatch(allactions.cohortActions[email](e.target.value))} onBlur={(e) => {populateErrors(email, e.target.value, true, 'string')}}/></div></Reminder> : <div className='col-md-12' style={{padding: '0'}}>
                <input className='form-control' name={email} value={cohort[email]} onChange={e => dispatch(allactions.cohortActions[email](e.target.value))} onBlur={(e) => {populateErrors(email, e.target.value, true, 'string')}} disabled={disabled}/></div>}  
            </div>
    </div>
     : 
    <div id={id} className={'col-md-'+colWidth} style={{marginLeft: '0', paddingLeft: leftPadding}}>                        
            <div className='col-md-12' style={{paddingLeft: '0', marginBottom: '4px'}}>
                ...
                <input className='form-control' name={name} value={cohort[name]} onChange={e => dispatch(allactions.cohortActions[name](e.target.value))} onBlur={(e) => {populateErrors(name, e.target.value, true, 'string')}} disabled={disabled}/></span>}  
            </div>
            <div  className='col-md-12' style={{paddingLeft: '0', marginBottom: '4px'}}>
            ...
            <div className='col-md-12'  style={{paddingLeft: '0'}}>
                ...
                <input className='form-control' type='phone' name={email} value={cohort[email]} onChange={e => dispatch(allactions.cohortActions[email](e.target.value))} onBlur={(e) => {populateErrors(email, e.target.value, true, 'email')}}  disabled={disabled}/></span>}
            </div>    
        </div>
}
