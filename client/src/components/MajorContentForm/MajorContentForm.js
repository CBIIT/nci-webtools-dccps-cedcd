                ...
                <div className='accordion' onClick={() => setActivePanel(activePanel === 'panelA' ? '' : 'panelA')}><span>Major Content Domains</span></div>
                    ...
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                ...
                                <input type='checkbox' name='seStatusBaseLine' checked={majorContent.seStatusBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setSeStatusBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.seStatusBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='seStatusFollowUp' checked={majorContent.seStatusFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setSeStatusFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.seStatusFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='educationBaseLine' checked={majorContent.educationBaseLine === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setEducationBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.educationBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='educationFollowUp' checked={majorContent.educationFollowUp === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setEducationFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.educationFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='maritalStatusBaseLine' checked={majorContent.maritalStatusBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setMaritalStatusBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.maritalStatusBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='maritalStatusFollowUp' checked={majorContent.maritalStatusFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setMaritalStatusFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.maritalStatusFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='originBaseLine' checked={majorContent.originBaseLine === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setOriginBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.originBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='originFollowUp' checked={majorContent.originFollowUp === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setOriginFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.originFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='empStatusBaseLine' checked={majorContent.empStatusBaseLine === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setEmpStatusBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.empStatusBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='empStatusFollowUp' checked={majorContent.empStatusFollowUp === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setEmpStatusFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.empStatusFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div>
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='insuranceStatusBaseLine' checked={majorContent.insuranceStatusBaseLine === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setInsuranceStatusBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.insuranceStatusBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='insuranceStatusFollowUp' checked={majorContent.insuranceStatusFollowUp === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setInsuranceStatusFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.insuranceStatusFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='anthropometryBaseLine' checked={majorContent.anthropometryBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setAnthropometryBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.anthropometryBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='anthropometryFollowUp' checked={majorContent.anthropometryFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setAnthropometryFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.anthropometryFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='dietaryBaseLine' checked={majorContent.dietaryBaseLine === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setDietaryBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.dietaryBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='dietaryFollowUp' checked={majorContent.dietaryFollowUp === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setDietaryFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.dietaryFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='supplementBaseLine' checked={majorContent.supplementBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setSupplementBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.supplementBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='supplementFollowUp' checked={majorContent.supplementFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setSupplementFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.supplementFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div>
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='medicineBaseLine' checked={majorContent.medicineBaseLine === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setMedicineBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.medicineBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='medicineFollowUp' checked={majorContent.medicineFollowUp === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setMedicineFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.medicineFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='prescriptionBaseLine' checked={majorContent.prescriptionBaseLine === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setPrescriptionBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.prescriptionBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='prescriptionFollowUp' checked={majorContent.prescriptionFollowUp === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setPrescriptionFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.prescriptionFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='nonprescriptionBaseLine' checked={majorContent.nonprescriptionBaseLine === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setNonprescriptionBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.nonprescriptionBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='nonprescriptionFollowUp' checked={majorContent.nonprescriptionFollowUp === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setNonprescriptionFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.nonprescriptionFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='alcoholBaseLine' checked={majorContent.alcoholBaseLine === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setAlcoholBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.alcoholBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='alcoholFollowUp' checked={majorContent.alcoholFollowUp === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setAlcoholFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.alcoholFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='cigaretteBaseLine' checked={majorContent.cigaretteBaseLine === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setCigaretteBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.cigaretteBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='cigaretteFollowUp' checked={majorContent.cigaretteFollowUp === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setCigaretteFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.cigaretteFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='physicalBaseLine' checked={majorContent.physicalBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setPhysicalBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.physicalBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='physicalFollowUp' checked={majorContent.physicalFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setPhysicalFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.physicalFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div>  
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='sleepBaseLine' checked={majorContent.sleepBaseLine === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setSleepBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.sleepBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='sleepFollowUp' checked={majorContent.sleepFollowUp === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setSleepFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.sleepFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div>
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='reproduceBaseLine' checked={majorContent.reproduceBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setReproduceBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.reproduceBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='reproduceFollowUp' checked={majorContent.reproduceFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setReproduceFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.reproduceFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div>   
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='reportedHealthBaseLine' checked={majorContent.reportedHealthBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setReportedHealthBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.reportedHealthBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='reportedHealthFollowUp' checked={majorContent.reportedHealthFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setReportedHealthFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.reportedHealthFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='lifeBaseLine' checked={majorContent.lifeBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setLifeBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.lifeBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='lifeFollowUp' checked={majorContent.lifeFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setLifeFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.lifeFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='socialSupportBaseLine' checked={majorContent.socialSupportBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setSocialSupportBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.socialSupportBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='socialSupportFollowUp' checked={majorContent.socialSupportFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setSocialSupportFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.socialSupportFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div>
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='cognitionBaseLine' checked={majorContent.cognitionBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setCognitionBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.cognitionBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='cognitionFollowUp' checked={majorContent.cognitionFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setCognitionFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.cognitionFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='depressionBaseLine' checked={majorContent.depressionBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setDepressionBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.depressionBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='depressionFollowUp' checked={majorContent.depressionFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setDepressionFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.depressionFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='psychosocialBaseLine' checked={majorContent.psychosocialBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setPsychosocialBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.psychosocialBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                    ...
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='fatigueBaseLine' checked={majorContent.fatigueBaseLine === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setFatigueBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.fatigueBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                    ...
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='cancerHistoryBaseLine' checked={majorContent.cancerHistoryBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setCancerHistoryBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.cancerHistoryBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='cancerHistoryFollowUp' checked={majorContent.cancerHistoryFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setCancerHistoryFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.cancerHistoryFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div>
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='cancerPedigreeBaseLine' checked={majorContent.cancerPedigreeBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setCancerPedigreeBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.cancerPedigreeBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='depressionFollowUp' checked={majorContent.cancerPedigreeFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setCancerPedigreeFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.cancerPedigreeFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='physicalMeasureBaseLine' checked={majorContent.physicalMeasureBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setPhysicalMeasureBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.physicalMeasureBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='physicalMeasureFollowUp' checked={majorContent.physicalMeasureFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setPhysicalMeasureFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.physicalMeasureFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='exposureBaseLine' checked={majorContent.exposureBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setExposureBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.exposureBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='exposureFollowUp' checked={majorContent.exposureFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setExposureFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.exposureFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div>
                    <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='col-md-8 col-xs-12'>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='residenceBaseLine' checked={majorContent.residenceBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setResidenceBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.residenceBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                </span>
                            </div>
                            <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                <span className='col-xs-12'>
                                <input type='checkbox' name='residenceFollowUp' checked={majorContent.residenceFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setResidenceFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.residenceFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                </span>
                            </div>
                        </div>
                    </div> 
                       ...
                       {/*} <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                        ...
                        <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                            ...
                            <div className='col-md-8 col-xs-12'>
                                <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                    <span className='col-xs-12'>
                                    <input type='checkbox' name='diabetesBaseLine' checked={majorContent.diabetesBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setDiabetesBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.diabetesBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                    </span>
                                </div>
                                <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                    <span className='col-xs-12'>
                                    <input type='checkbox' name='diabetesFollowUp' checked={majorContent.diabetesFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setDiabetesFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.diabetesFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                            ...
                            <div className='col-md-8 col-xs-12'>
                                <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                    <span className='col-xs-12'>
                                    <input type='checkbox' name='strokeBaseLine' checked={majorContent.strokeBaseLine === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setStrokeBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.strokeBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                    </span>
                                </div>
                                <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                    <span className='col-xs-12'>
                                    <input type='checkbox' name='strokeFollowUp' checked={majorContent.strokeFollowUp === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setStrokeFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.strokeFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                            ...
                            <div className='col-md-8 col-xs-12'>
                                <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                    <span className='col-xs-12'>
                                    <input type='checkbox' name='copdBaseLine' checked={majorContent.copdBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setCopdBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.copdBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                    </span>
                                </div>
                                <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                    <span className='col-xs-12'>
                                    <input type='checkbox' name='copdFollowUp' checked={majorContent.copdFollowUp === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setCopdFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.copdFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                            ...
                            <div className='col-md-8 col-xs-12'>
                                <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                    <span className='col-xs-12'>
                                    <input type='checkbox' name='cardiovascularBaseLine' checked={majorContent.cardiovascularBaseLine === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setCardiovascularBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.cardiovascularBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                    </span>
                                </div>
                                <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                    <span className='col-xs-12'>
                                    <input type='checkbox' name='cardiovascularFollowUp' checked={majorContent.cardiovascularFollowUp === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setCardiovascularFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.cardiovascularFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                            ...
                            <div className='col-md-8 col-xs-12'>
                                <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                    <span className='col-xs-12'>
                                    <input type='checkbox' name='osteoporosisBaseLine' checked={majorContent.osteoporosisBaseLine === 1} onClick={(e) => { dispatch(allactions.majorContentActions.setOsteoporosisBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.osteoporosisBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                    </span>
                                </div>
                                <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                    <span className='col-xs-12'>
                        ...
                        <div className='specimenInfo my-3 col-md-12 col-xs-12'>
                            ...
                            <div className='col-md-8 col-xs-12'>
                                <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                    <span className='col-xs-12'>
                                    <input type='checkbox' name='mentalBaseLine' checked={majorContent.mentalBaseLine === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setMentalBaseLine(+e.target.checked)); dispatch(allactions.majorContentErrorActions.mentalBaseLine(e.target.checked)) }} />{' '} Collected at baseline
                                    </span>
                                </div>
                                <div className='col-md-6 col-xs-12' style={{paddingLeft: '0'}}>
                                    <span className='col-xs-12'>
                                    <input type='checkbox' name='mentalFollowUp' checked={majorContent.mentalFollowUp === 1} onChange={(e) => { dispatch(allactions.majorContentActions.setMentalFollowUp(+e.target.checked)); dispatch(allactions.majorContentErrorActions.mentalFollowUp(e.target.checked)) }} />{' '} Collected during follow-up
                                    </span>
                                </div>
                            </div>
                        </div>
